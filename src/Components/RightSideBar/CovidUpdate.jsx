  ...
  return (
    <div className=" my-2 bg-white h-[300px] px-4 py-4 pt-4 rounded-md border-[#EDEBEB] border-2">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="bg-gradient-to-r from-hotPink to-orangePeach w-1/2 lg:h-[190px] md:h-auto lg:overflow-y-scroll text-center text-[#FBFBFB] font-medium rounded-md upcomming-appoinment grid md:grid-cols-2 lg:grid-cols-1">
